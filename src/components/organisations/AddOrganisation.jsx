...
import { addOrganisation, registerEmployee } from "../../utils/common";

const AddOrganisation = ({ isOpen, handleClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const isOrganisationAdded = await addOrganisation(formData);

    if (isOrganisationAdded) {
      handleClose();
